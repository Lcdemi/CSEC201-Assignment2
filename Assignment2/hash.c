...
int digest_equal(struct Digest* digest1, struct Digest* digest2) {
	...
	if (digest1->hash0 == digest2->hash0 && digest1->hash1 == digest2->hash1 && digest1->hash2 == digest2->hash2 && digest1->hash3 == digest2->hash3 && digest1->hash4 == digest2->hash4) {
		return 1;
	}
	else {
		return 0;
...
void printDigest(struct Digest* digest1) {
	printf("%d %d %d %d %d\n", digest1->hash0, digest1->hash1, digest1->hash2, digest1->hash3, digest1->hash4);
}